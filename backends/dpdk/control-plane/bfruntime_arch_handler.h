 ...
 public:
   ...
   void addActionSelector(const P4RuntimeSymbolTableIface& symbols,
    ...
    void collectExternInstance(P4RuntimeSymbolTableIface* symbols,
        ...
        } else if (externBlock->type->name == ActionProfileTraits<Arch::PSA>::typeName() ||
                   externBlock->type->name == ActionSelectorTraits<Arch::PSA>::typeName()) {
            symbols->add(SymbolTypeDPDK::ACTION_SELECTOR(), decl->controlPlaneName() + "_sel");
        }
    }
